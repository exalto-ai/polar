...
export class Mcp {
   ...
   * The MCP transport answers 404 for that expired session. Without recovery
  ...
  */
  ...
  private async send(
    ...
    // The MCP transport returns 404 for an expired session. Authorization
    // failures stay hard failures: retrying the same bearer cannot repair one.
